...
try{
  const result=await fetch(`https://api.weatherapi.com/v1/forecast.json?key=9547e57b38b94b34a7483936240310&q=${city}&days=3`)
...
// get the location of the user and get the data of the location
